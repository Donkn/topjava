...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    public void duplicateMailCreate() {
        assertThrows(DataAccessException.class, () -> service.create(new User(null, "Duplicate", "user@yandex.ru", "newPass", Role.USER)));
    }
    ...
    public void createWithException() throws Exception {
        Assume.assumeTrue(!service.getClass().equals(JdbcUserRepository.class));
