...
public class JdbcMealRepository implements MealRepository {
    ...
    private final Logger log= LoggerFactory.getLogger(JdbcMealRepository.class);
    ...
    public Meal get(int id, int userId) {
        ...
        log.info("Result List meals {}", meals );
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? " +
                "BETWEEN dateTime=? AND dateTime=?", ROW_MAPPER, userId, startDateTime, endDateTime);
    }
}
